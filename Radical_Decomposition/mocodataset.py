...
parser.add_argument('--epochs', default=140, type=int, metavar='N', help='number of total epochs to run')
...
class Mydata(Dataset) :
    ...
    def __getitem__(self, item):
        ...
        im_2 = random_gaussian_blur(im_2)
        return im_1, im_2
